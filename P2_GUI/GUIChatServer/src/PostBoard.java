...
public class PostBoard {
	public PostBoard(){
		...
		m_vRegisteredWidgetType = new Vector<String>();
		
		registerPostType( "String" );
		registerWidgetType( "RectangleWidget" );
		registerWidgetType( "CircleWidget" );
		registerWidgetType( "JugglerWidget" );
		registerWidgetType( "TimerWidget");
	}
	...
	public boolean isWidgetType( String sWidgetType ){
		for( int i=0; i<m_vRegisteredWidgetType.size(); i++){
			if( m_vRegisteredWidgetType.get(i).equals( sWidgetType ) ) return true;
		}
		return false;
	}
	...
	public void registerWidgetType( String sWidgetType ){
		m_vRegisteredWidgetType.add( sWidgetType );
	}

	public boolean unRegisterWidgetType( String sWidgetType ){
		return m_vRegisteredWidgetType.remove( sWidgetType );
	}
	
	int m_iSerialNumber;
	private Vector<String> m_vRegisteredWidgetType;
