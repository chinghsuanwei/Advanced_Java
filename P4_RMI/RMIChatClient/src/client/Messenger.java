...
import task.DisplayResultForTA;
...
public class Messenger implements Runnable{
	...
	private void login( String sTokens[] ) {
		...
		//It's for TA
		DisplayResultForTA.sUsername = m_sUsername;
		// initailRMI 必須要等到 username 確定以後 才能以username去rebind
		cmdDispatcher.initialRMI();
	...
	private void change( String sTokens[] ){
		...
		postBoard.changeWidget( iWidgetId, sProperty );
